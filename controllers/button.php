        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
					...
					<a href="/crud/controllers/delete.php?id=<?php echo $row['userid']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a>
					</div>
    ...
    <div class="modal fade" id="edit<?php echo $row['userid']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
				...
				?>
				<div class="container-fluid">
                <form method="POST" action="/crud/controllers/edit.php?id=<?php echo $erow['userid']; ?>">
                <div class="row">
						<div class="col-lg-2">
